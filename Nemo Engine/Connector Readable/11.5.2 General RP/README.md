...
2. Read `prompt-index.jsonl` to locate any prompt, or every file listed under `prompt_shards` to inspect all 458 prompts.
...
If code-mode access is available, the connector can also call `github_fetch_blob` with blob `34a469106a1df6fa88a77e3ae0673d0271e21fee`, then parse `result.content` inside the tool call without printing the entire 1.7 MB payload. Do not fall back to 11.3 merely because a direct rendered response is truncated.

## Integrity

- Source commit: `6de820a723a5d68d5d3a288fdfd14a43c4951d1a`
- Git blob: `34a469106a1df6fa88a77e3ae0673d0271e21fee`
- Source bytes: `1700950`
- Source SHA-256: `c5e13e951340d17addef0e16e7a7152a8256c41f2c046a52e81d86e1feef31d4`
- Prompts: `458`
